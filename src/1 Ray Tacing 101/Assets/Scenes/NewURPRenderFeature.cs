...
public class NewURPRenderFeature : ScriptableRendererFeature
{
    ...
    class NewURPRenderFeaturePass : ScriptableRenderPass
    {
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            var resultTex = UniversalRenderer.CreateRenderGraphTexture(renderGraph, rtdesc, "_RayracedColor", false);

            if (rayTracingAccelerationStructure == null)
            {
                var setting = new RayTracingAccelerationStructure.Settings();
                setting.rayTracingModeMask = RayTracingAccelerationStructure.RayTracingModeMask.Everything;
                setting.layerMask = 255;
                setting.managementMode = RayTracingAccelerationStructure.ManagementMode.Automatic;
